...
def run_script(script_path):
    ...
    startupinfo.dwFlags |= subprocess.STARTF_USESHOWWINDOW  # Hide the subprocess window
    subprocess.Popen(['pythonw', script_path], startupinfo=startupinfo)

# Original functions and main script
